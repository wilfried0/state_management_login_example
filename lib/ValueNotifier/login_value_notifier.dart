...
import 'package:state_management_tuto/ValueNotifier/notifiers/password_visibility_value_notifier_notifier.dart';
...
import 'notifiers/login_value_notifier_notifier.dart';

class LoginValueNotifier extends StatelessWidget {
  final TextEditingController usernameController = TextEditingController(), passwordController = TextEditingController();
  LoginValueNotifier({super.key});
  ...
  Widget build(BuildContext context) {
    LoginValueNotifierNotifier loginValueNotifier = LoginValueNotifierNotifier(LoginValueNotifierService());
    PasswordVisibilityValueNotifier passwordVisibilityValueNotifier = PasswordVisibilityValueNotifier(false);
    return Scaffold(
        ...
        child: Column(
          ...
          children: [
            ...
            ValueListenableBuilder(
                valueListenable: passwordVisibilityValueNotifier,
                ...
                return TextField(
                  ...
                  decoration: InputDecoration(
                      ...
                      suffixIcon: IconButton(
                        onPressed: () {
                          passwordVisibilityValueNotifier.passwordVisibility();
                        },
                        icon: Icon(value?Icons.visibility_off:Icons.visibility, color: Colors.grey, size: 25,),
                      ),
                      hintText: 'Password',
                      border: InputBorder.none,
